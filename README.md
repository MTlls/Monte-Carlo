...
```
cd existing_repo
git remote add origin https://gitlab.c3sl.ufpr.br/mtb21/monte-carlo.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.c3sl.ufpr.br/mtb21/monte-carlo/-/settings/integrations)
